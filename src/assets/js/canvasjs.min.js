...
k?k:"gray",d.setLineDash&&d.setLineDash(N(v,m)),d.beginPath(),d.moveTo(h.point.x,h.point.y),0<=p.indexOf("bar")||"error"===p&&h.axisSwapped?d.lineTo(n-(0<h.direction?0:-u)+("vertical"===x?-u/2:0),q+("vertical"===x?-A/2:0)):0<=p.indexOf("column")||"error"===p&&!h.axisSwapped?d.lineTo(n+("horizontal"===x?u/2:0),q+((0<h.direction?A:-A)+("vertical"===x?-A:0))/2):d.lineTo(n+("horizontal"===x?u/2:0),q+((q<h.point.y?A:-A)+("vertical"===x?-A:0))/2),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,
easingFunction:M.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)h=this._indexLabels[a],g=ha("indexLabelBackgroundColor",h.dataPoint,h.dataSeries),h.dataSeries.indexLabelBackgroundColor=r(g)?t?"transparent":null:g;return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,
...
b.moveTo(x,r))));l={x:x,y:r};s<p.length-1&&(k!==(p[s].lineColor||v)||n!==(p[s].lineDashType||h.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,r),k=p[s].lineColor||v,c.strokeStyle=k,c.setLineDash&&(p[s].lineDashType?(n=p[s].lineDashType,c.setLineDash(N(n,h.lineThickness))):(n=h.lineDashType,c.setLineDash(g))));if(0<p[s].markerSize||0<h.markerSize){var B=h.getMarkerProperties(s,x,r,c);f.push(B);z=Q(z);t&&f.push({x:x,y:r,ctx:b,type:B.type,size:B.size,color:z,borderColor:z,borderThickness:B.borderThickness})}(p[s].indexLabel||
h.indexLabel||p[s].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:p[s],dataSeries:h,point:{x:x,y:r},direction:0>p[s].y===a.axisY.reversed?1:-1,color:v})}c.stroke();t&&b.stroke()}}X.drawMarkers(f);t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStepLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=
...
a.dataSeriesIndexes[u],h=this.data[A];b.lineWidth=h.lineThickness;var p=h.dataPoints,n="solid";if(b.setLineDash){var q=N(h.nullDataLineDashType,h.lineThickness),n=h.lineDashType,g=N(n,h.lineThickness);b.setLineDash(g)}var v=h.id;this._eventManager.objectMap[v]={objectType:"dataSeries",dataSeriesIndex:A};v=Q(v);e.strokeStyle=v;e.lineWidth=0<h.lineThickness?Math.max(h.lineThickness,4):0;var v=h._colorSet,k=v=h.lineColor=h.options.lineColor?h.options.lineColor:v[0];b.strokeStyle=v;var m=0,s,x,r=[];b.beginPath();
...
{id:C,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:m,x1:s,y1:x};r[r.length]={x:s,y:x};m<p.length-1&&(k!==(p[m].lineColor||v)||n!==(p[m].lineDashType||h.lineDashType))&&(k=p[m].lineColor||v,r[r.length-1].newStrokeStyle=k,b.setLineDash&&(p[m].lineDashType?(n=p[m].lineDashType,r[r.length-1].newLineDashArray=N(n,h.lineThickness)):(n=h.lineDashType,r[r.length-1].newLineDashArray=g)));if(0<p[m].markerSize||0<h.markerSize){var z=h.getMarkerProperties(m,s,x,b);l.push(z);C=Q(C);t&&l.push({x:s,y:x,
ctx:e,type:z.type,size:z.size,color:C,borderColor:C,borderThickness:z.borderThickness})}(p[m].indexLabel||h.indexLabel||p[m].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:p[m],dataSeries:h,point:{x:s,y:x},direction:0>p[m].y===a.axisY.reversed?1:-1,color:v});x=!1}d(r)}X.drawMarkers(l);t&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,
this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(f.x1,f.y1,f.width,f.height),e.beginPath());b.restore();b.beginPath();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:
...
a.axisX.convertValueToPixel(A);u=a.axisY.convertValueToPixel(v[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+p)*n<<0:l-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var m=a.axisX.reversed?l-n<<0:l+n<<0,s;0<=v[f].y?s=h:(s=u,u=h);u>s&&(b=u,u=s,s=b);b=v[f].color?v[f].color:g._colorSet[f%g._colorSet.length];V(c,l,u,m,s,b,0,null,k&&0<=v[f].y,0>v[f].y&&k,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",
dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:u,x2:m,y2:s};b=Q(b);t&&V(this._eventManager.ghostCtx,l,u,m,s,b,0,null,!1,!1,!1,!1);(v[f].indexLabel||g.indexLabel||v[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:v[f],dataSeries:g,point:{x:l+(m-l)/2,y:0>v[f].y===a.axisY.reversed?u:s},direction:0>v[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(u,s),x2:m,y2:Math.max(u,s)},color:b})}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
B+(z-n);b=s[h].color?s[h].color:m._colorSet[h%m._colorSet.length];V(c,r,n,C,z,b,0,null,x&&0<=s[h].y,0>s[h].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:r,y1:n,x2:C,y2:z};b=Q(b);t&&V(this._eventManager.ghostCtx,r,n,C,z,b,0,null,!1,!1,!1,!1);(s[h].indexLabel||m.indexLabel||s[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn100",dataPoint:s[h],dataSeries:m,
point:{x:p,y:0<=s[h].y?n:z},direction:0>s[h].y===a.axisY.reversed?1:-1,bounds:{x1:r,y1:Math.min(n,z),x2:C,y2:Math.max(n,z)},color:b})}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,u,A,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
n/2-(a.previousDataSeriesCount+p)*n<<0:u-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var m=a.axisX.reversed?u-n<<0:u+n<<0,s;0<=v[f].y?s=h:(s=l,l=h);b=v[f].color?v[f].color:g._colorSet[f%g._colorSet.length];V(c,s,u,l,m,b,0,null,k,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:s,y1:u,x2:l,y2:m};b=Q(b);t&&V(this._eventManager.ghostCtx,s,u,l,m,b,0,null,!1,!1,!1,!1);(v[f].indexLabel||g.indexLabel||
...
0<=s[h].y){var B=f[b]?f[b]:0;z=q+B;p+=B;f[b]=B+(p-z)}else B=l[b]?l[b]:0,z=p-B,p=q-B,l[b]=B+(p-z);b=s[h].color?s[h].color:m._colorSet[h%m._colorSet.length];V(c,z,r,p,C,b,0,null,x,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:z,y1:r,x2:p,y2:C};b=Q(b);t&&V(this._eventManager.ghostCtx,z,r,p,C,b,0,null,!1,!1,!1,!1);(s[h].indexLabel||m.indexLabel||s[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",
...
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderStackedBar100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,
...
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=function(a){var d,c;function b(){z&&(0<g.lineThickness&&
...
u=a.axisY.lineCoordinates,A=[],h=this.plotArea,p;f.save();t&&l.save();f.beginPath();f.rect(h.x1,h.y1,h.width,h.height);f.clip();t&&(l.beginPath(),l.rect(h.x1,h.y1,h.width,h.height),l.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],v=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};A=Q(A);l.fillStyle=A;A=[];d=!0;var k=0,m,s,r,F=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
C,z=null;if(0<v.length){var B=g._colorSet[k%g._colorSet.length],w=g.lineColor=g.options.lineColor||B,y=w;f.fillStyle=B;f.strokeStyle=w;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var T=N(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var O=N(c,g.lineThickness);f.setLineDash(O)}for(var ja=!0;k<v.length;k++)if(r=v[k].x.getTime?v[k].x.getTime():v[k].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ja)))if("number"!==typeof v[k].y)g.connectNullData||
(ja||d)||b(),ja=!0;else{m=a.axisX.convertValueToPixel(r);s=a.axisY.convertValueToPixel(v[k].y);d||ja?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=s,m=p.x,s=p.y,b(),f.moveTo(p.x,p.y),m=d,s=c,z=p,c=g.nullDataLineDashType,f.setLineDash(T)),f.lineTo(m,s),t&&l.lineTo(m,s)):(f.beginPath(),f.moveTo(m,s),t&&(l.beginPath(),l.moveTo(m,s)),z={x:m,y:s}),ja=d=!1):(f.lineTo(m,s),t&&l.lineTo(m,s),0==k%250&&b());p={x:m,
y:s};k<v.length-1&&(y!==(v[k].lineColor||w)||c!==(v[k].lineDashType||g.lineDashType))&&(b(),y=v[k].lineColor||w,f.strokeStyle=y,f.setLineDash&&(v[k].lineDashType?(c=v[k].lineDashType,f.setLineDash(N(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(O))));var $=g.dataPointIds[k];this._eventManager.objectMap[$]={id:$,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:k,x1:m,y1:s};0!==v[k].markerSize&&(0<v[k].markerSize||0<g.markerSize)&&(r=g.getMarkerProperties(k,m,s,f),A.push(r),$=Q($),t&&
...
0;A<a.dataSeriesIndexes.length;A++){var h=a.dataSeriesIndexes[A],p=this.data[h],n=p.dataPoints,l=p.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:h};l=Q(l);e.fillStyle=l;var l=[],q=0,g,v,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,s=null,r=[];if(0<n.length){var F=p._colorSet[q%p._colorSet.length],C=p.lineColor=p.options.lineColor||F,z=C;b.fillStyle=F;b.strokeStyle=C;b.lineWidth=p.lineThickness;var B="solid";if(b.setLineDash){var y=N(p.nullDataLineDashType,
...
p.getMarkerProperties(q,g,v,b);l.push(O);T=Q(T);t&&l.push({x:g,y:v,ctx:e,type:O.type,size:O.size,color:T,borderColor:T,borderThickness:O.borderThickness})}(n[q].indexLabel||p.indexLabel||n[q].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:n[q],dataSeries:p,point:{x:g,y:v},direction:0>n[q].y===a.axisY.reversed?1:-1,color:F});v=!1}d();X.drawMarkers(l)}}t&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
"source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(u.x1,u.y1,u.width,u.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStepArea=
...
e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,u=a.axisY.lineCoordinates,A=[],h=this.plotArea,p;f.save();t&&l.save();f.beginPath();f.rect(h.x1,h.y1,h.width,h.height);f.clip();t&&(l.beginPath(),l.rect(h.x1,h.y1,h.width,h.height),l.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],v=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};A=Q(A);l.fillStyle=A;A=[];d=!0;var k=0,m,s,r,F=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),C,z=null;c=!1;if(0<v.length){var B=g._colorSet[k%g._colorSet.length],w=g.lineColor=g.options.lineColor||B,y=w;f.fillStyle=B;f.strokeStyle=w;f.lineWidth=g.lineThickness;var T="solid";if(f.setLineDash){var O=N(g.nullDataLineDashType,g.lineThickness),T=g.lineDashType,D=N(T,g.lineThickness);f.setLineDash(D)}for(;k<v.length;k++)if(r=v[k].x.getTime?v[k].x.getTime():v[k].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var $=s;"number"!==
...
!1):(f.lineTo(m,$),t&&l.lineTo(m,$),f.lineTo(m,s),t&&l.lineTo(m,s),0==k%250&&b()),p={x:m,y:s},k<v.length-1&&(y!==(v[k].lineColor||w)||T!==(v[k].lineDashType||g.lineDashType))&&(b(),y=v[k].lineColor||w,f.strokeStyle=y,f.setLineDash&&(v[k].lineDashType?(T=v[k].lineDashType,f.setLineDash(N(T,g.lineThickness))):(T=g.lineDashType,f.setLineDash(D)))),r=g.dataPointIds[k],this._eventManager.objectMap[r]={id:r,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:k,x1:m,y1:s},0!==v[k].markerSize&&(0<v[k].markerSize||
0<g.markerSize)&&($=g.getMarkerProperties(k,m,s,f),A.push($),r=Q(r),t&&A.push({x:m,y:s,ctx:l,type:$.type,size:$.size,color:r,borderColor:r,borderThickness:$.borderThickness})),(v[k].indexLabel||g.indexLabel||v[k].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:v[k],dataSeries:g,point:{x:m,y:s},direction:0>v[k].y===a.axisY.reversed?1:-1,color:B}))}b();X.drawMarkers(A)}}t&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation=
...
B=this.data[z];w=B.dataPoints;x=!0;h=[];q=B.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:z};q=Q(q);r.fillStyle=q;if(0<p.length){var e=B._colorSet[0],y=B.lineColor=B.options.lineColor||e,T=y;b.fillStyle=e;b.strokeStyle=y;b.lineWidth=B.lineThickness;F="solid";if(b.setLineDash){var O=N(B.nullDataLineDashType,B.lineThickness);F=B.lineDashType;var D=N(F,B.lineThickness);b.setLineDash(D)}for(var $=!0,q=0;q<p.length;q++){var f=p[q],ea=null,ea=0<=B.dataPointIndexes[f]?w[B.dataPointIndexes[f]]:
{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!$)))if("number"!==typeof ea.y)B.connectNullData||($||x)||d(),$=!0;else{g=a.axisX.convertValueToPixel(f);var ka=A[f]?A[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){n[f]=ea.y+(n[f]?n[f]:0);if(0>=n[f]&&a.axisY.logarithmic)continue;k=a.axisY.convertValueToPixel(n[f])}else k=a.axisY.convertValueToPixel(ea.y),k-=ka;h.push({x:g,y:m-ka});A[f]=m-k;x||$?(!x&&
B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||F===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(x=h.pop(),F=h[h.length-1],d(),b.moveTo(s.x,s.y),h.push(F),h.push(x),F=B.nullDataLineDashType,b.setLineDash(O)),b.lineTo(g,k),t&&r.lineTo(g,k)):(b.beginPath(),b.moveTo(g,k),t&&(r.beginPath(),r.moveTo(g,k))),$=x=!1):(b.lineTo(g,k),t&&r.lineTo(g,k),0==q%250&&(d(),b.moveTo(g,k),t&&r.moveTo(g,k),h.push({x:g,y:m-ka})));s={x:g,y:k};q<w.length-1&&(T!==(w[q].lineColor||y)||F!==
(w[q].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,k),h.push({x:g,y:m-ka}),T=w[q].lineColor||y,b.strokeStyle=T,b.setLineDash&&(w[q].lineDashType?(F=w[q].lineDashType,b.setLineDash(N(F,B.lineThickness))):(F=B.lineDashType,b.setLineDash(D))));if(0<=B.dataPointIndexes[f]){var E=B.dataPointIds[B.dataPointIndexes[f]];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:k}}0<=B.dataPointIndexes[f]&&0!==ea.markerSize&&
(0<ea.markerSize||0<B.markerSize)&&(ka=B.getMarkerProperties(B.dataPointIndexes[f],g,k,b),l.push(ka),f=Q(E),t&&l.push({x:g,y:k,ctx:r,type:ka.type,size:ka.size,color:f,borderColor:f,borderThickness:ka.borderThickness}));(ea.indexLabel||B.indexLabel||ea.indexLabelFormatter||B.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ea,dataSeries:B,point:{x:g,y:k},direction:0>w[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,k);t&&r.moveTo(g,k)}delete B.dataPointIndexes}X.drawMarkers(l);
t&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(u.x1,u.y1,u.width,u.height),r.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,
easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<B.lineThickness&&b.stroke();0<h.length;){var a=h.pop();b.lineTo(a.x,a.y);t&&F.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=B.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();t&&(F.closePath(),F.fill(),F.beginPath());h=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=t?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,u=[],k=[],h=[],p=[],n=[],q=
...
!0);p.sort(Pa)}for(C=0;C<a.dataSeriesIndexes.length;C++){z=a.dataSeriesIndexes[C];B=this.data[z];w=B.dataPoints;r=!0;e=B.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:z};e=Q(e);F.fillStyle=e;h=[];if(0<p.length){var e=B._colorSet[q%B._colorSet.length],y=B.lineColor=B.options.lineColor||e,T=y;b.fillStyle=e;b.strokeStyle=y;b.lineWidth=B.lineThickness;s="solid";if(b.setLineDash){var O=N(B.nullDataLineDashType,B.lineThickness);s=B.lineDashType;var D=N(s,B.lineThickness);b.setLineDash(D)}for(var $=
!0,q=0;q<p.length;q++){var f=p[q],ea=null,ea=0<=B.dataPointIndexes[f]?w[B.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!$)))if("number"!==typeof ea.y)B.connectNullData||($||r)||d(),$=!0;else{var ka;ka=0!==a.dataPointYSums[f]?100*(ea.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var E=k[f]?k[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){n[f]=ka+(n[f]?n[f]:0);if(0>=
n[f]&&a.axisY.logarithmic)continue;v=a.axisY.convertValueToPixel(n[f])}else v=a.axisY.convertValueToPixel(ka),v-=E;h.push({x:g,y:x-E});k[f]=x-v;r||$?(!r&&B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||s===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(r=h.pop(),s=h[h.length-1],d(),b.moveTo(m.x,m.y),h.push(s),h.push(r),s=B.nullDataLineDashType,b.setLineDash(O)),b.lineTo(g,v),t&&F.lineTo(g,v)):(b.beginPath(),b.moveTo(g,v),t&&(F.beginPath(),F.moveTo(g,v))),$=r=!1):(b.lineTo(g,
v),t&&F.lineTo(g,v),0==q%250&&(d(),b.moveTo(g,v),t&&F.moveTo(g,v),h.push({x:g,y:x-E})));m={x:g,y:v};q<w.length-1&&(T!==(w[q].lineColor||y)||s!==(w[q].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,v),h.push({x:g,y:x-E}),T=w[q].lineColor||y,b.strokeStyle=T,b.setLineDash&&(w[q].lineDashType?(s=w[q].lineDashType,b.setLineDash(N(s,B.lineThickness))):(s=B.lineDashType,b.setLineDash(D))));if(0<=B.dataPointIndexes[f]){var G=B.dataPointIds[B.dataPointIndexes[f]];this._eventManager.objectMap[G]=
{id:G,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:v}}0<=B.dataPointIndexes[f]&&0!==ea.markerSize&&(0<ea.markerSize||0<B.markerSize)&&(E=B.getMarkerProperties(q,g,v,b),u.push(E),f=Q(G),t&&u.push({x:g,y:v,ctx:F,type:E.type,size:E.size,color:f,borderColor:f,borderThickness:E.borderThickness}));(ea.indexLabel||B.indexLabel||ea.indexLabelFormatter||B.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ea,dataSeries:B,point:{x:g,y:v},
...
b.clearRect(l.x1,l.y1,l.width,l.height),F.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderBubble=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),
...
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderScatter=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();t&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();t&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,b.y1,
...
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderCandlestick=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=
...
m.prototype.renderBoxAndWhisker=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=t?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=this.plotArea,l=0,u,k,h,p,n,q,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.015*this.width,v=a.axisX.dataInfo.minDiff;isFinite(v)||(v=0.3*Math.abs(a.axisX.range));
v=this.options.dataPointWidth?this.dataPointWidth:0.7*f.width*(a.axisX.logarithmic?Math.log(v)/Math.log(a.axisX.range):Math.abs(v)/Math.abs(a.axisX.range))<<0;this.dataPointMaxWidth&&e>l&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<e)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));v<e&&(v=e);v>l&&(v=l);c.save();t&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();t&&(b.beginPath(),
b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var m=!1,m=!!a.axisY.reversed,w=0;w<a.dataSeriesIndexes.length;w++){var s=a.dataSeriesIndexes[w],x=this.data[s],F=x.dataPoints;if(0<F.length)for(var C=5<v&&x.bevelEnabled?!0:!1,l=0;l<F.length;l++)if(F[l].getTime?g=F[l].x.getTime():g=F[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!r(F[l].y)&&F[l].y.length&&"number"===typeof F[l].y[0]&&"number"===typeof F[l].y[1]&&"number"===typeof F[l].y[2]&&"number"===typeof F[l].y[3]&&"number"===
typeof F[l].y[4]&&5===F[l].y.length){u=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(F[l].y[0]);h=a.axisY.convertValueToPixel(F[l].y[1]);p=a.axisY.convertValueToPixel(F[l].y[2]);n=a.axisY.convertValueToPixel(F[l].y[3]);q=a.axisY.convertValueToPixel(F[l].y[4]);var z=u-v/2<<0,B=u+v/2<<0,e=F[l].color?F[l].color:x._colorSet[0],y=Math.round(Math.max(1,0.15*v)),D=0===y%2?0:0.5,T=F[l].whiskerColor?F[l].whiskerColor:F[l].color?x.whiskerColor?x.whiskerColor:F[l].color:x.whiskerColor?x.whiskerColor:
e,O="number"===typeof F[l].whiskerThickness?F[l].whiskerThickness:"number"===typeof x.options.whiskerThickness?x.whiskerThickness:y,E=F[l].whiskerDashType?F[l].whiskerDashType:x.whiskerDashType,$=r(F[l].whiskerLength)?r(x.options.whiskerLength)?v:x.whiskerLength:F[l].whiskerLength,$="number"===typeof $?0>=$?0:$>=v?v:$:"string"===typeof $?parseInt($)*v/100>v?v:parseInt($)*v/100:v,ea=1===Math.round(O)%2?0.5:0,ka=F[l].stemColor?F[l].stemColor:F[l].color?x.stemColor?x.stemColor:F[l].color:x.stemColor?
x.stemColor:e,za="number"===typeof F[l].stemThickness?F[l].stemThickness:"number"===typeof x.options.stemThickness?x.stemThickness:y,G=1===Math.round(za)%2?0.5:0,I=F[l].stemDashType?F[l].stemDashType:x.stemDashType,J=F[l].lineColor?F[l].lineColor:F[l].color?x.lineColor?x.lineColor:F[l].color:x.lineColor?x.lineColor:e,K="number"===typeof F[l].lineThickness?F[l].lineThickness:"number"===typeof x.options.lineThickness?x.lineThickness:y,P=F[l].lineDashType?F[l].lineDashType:x.lineDashType,L=1===Math.round(K)%
2?0.5:0,S=x.upperBoxColor,ua=x.lowerBoxColor,qa=r(x.options.fillOpacity)?1:x.fillOpacity,R=x.dataPointIds[l];this._eventManager.objectMap[R]={id:R,objectType:"dataPoint",dataSeriesIndex:s,dataPointIndex:l,x1:z,y1:k,x2:B,y2:h,x3:u,y3:p,x4:u,y4:n,y5:q,borderThickness:y,color:e,stemThickness:za,stemColor:ka,whiskerThickness:O,whiskerLength:$,whiskerColor:T,lineThickness:K,lineColor:J};c.save();0<za&&(c.beginPath(),c.strokeStyle=ka,c.lineWidth=za,c.setLineDash&&c.setLineDash(N(I,za)),c.moveTo(u-G,h),
c.lineTo(u-G,k),c.stroke(),c.moveTo(u-G,n),c.lineTo(u-G,p),c.stroke());c.restore();b.lineWidth=Math.max(y,4);c.beginPath();V(c,z,Math.min(q,h),B,Math.max(h,q),ua,0,e,m?C:!1,m?!1:C,!1,!1,qa);c.beginPath();V(c,z,Math.min(p,q),B,Math.max(q,p),S,0,e,m?!1:C,m?C:!1,!1,!1,qa);c.beginPath();c.lineWidth=y;c.strokeStyle=e;c.rect(z-D,Math.min(h,p)-D,B-z+2*D,Math.max(h,p)-Math.min(h,p)+2*D);c.stroke();c.save();0<K&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(N(P,K)),c.strokeStyle=J,c.lineWidth=
K,c.moveTo(z,q-L),c.lineTo(B,q-L),c.stroke());c.restore();c.save();0<O&&(c.beginPath(),c.setLineDash&&c.setLineDash(N(E,O)),c.strokeStyle=T,c.lineWidth=O,c.moveTo(u-$/2<<0,n-ea),c.lineTo(u+$/2<<0,n-ea),c.stroke(),c.moveTo(u-$/2<<0,k+ea),c.lineTo(u+$/2<<0,k+ea),c.stroke());c.restore();t&&(e=Q(R),b.strokeStyle=e,b.lineWidth=za,0<za&&(b.moveTo(u-D-G,h),b.lineTo(u-D-G,Math.max(k,n)),b.stroke(),b.moveTo(u-D-G,Math.min(k,n)),b.lineTo(u-D-G,p),b.stroke()),V(b,z,Math.max(h,p),B,Math.min(h,p),e,0,null,!1,
!1,!1,!1),0<O&&(b.beginPath(),b.lineWidth=O,b.moveTo(u+$/2,n-ea),b.lineTo(u-$/2,n-ea),b.stroke(),b.moveTo(u+$/2,k+ea),b.lineTo(u-$/2,k+ea),b.stroke()));(F[l].indexLabel||x.indexLabel||F[l].indexLabelFormatter||x.indexLabelFormatter)&&this._indexLabels.push({chartType:x.type,dataPoint:F[l],dataSeries:x,point:{x:z+(B-z)/2,y:a.axisY.reversed?k:n},direction:1,bounds:{x1:z,y1:Math.min(k,n),x2:B,y2:Math.max(k,n)},color:e})}}t&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation=
...
a.axisY.convertValueToPixel(g[f].y[0]);u=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*h/2-(a.previousDataSeriesCount+p)*h<<0:b-a.plotType.totalDataSeries*h/2+(a.previousDataSeriesCount+p)*h<<0,w=a.axisX.reversed?m-h<<0:m+h<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>u){var s=l;l=u;u=s}s=q.dataPointIds[f];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:f,x1:m,y1:l,x2:w,y2:u};V(c,m,l,w,
u,b,0,b,v,v,!1,!1,q.fillOpacity);b=Q(s);t&&V(this._eventManager.ghostCtx,m,l,w,u,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(w-m)/2,y:g[f].y[1]>=g[f].y[0]?u:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:m,y1:Math.min(l,u),x2:w,y2:Math.max(l,u)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:1,
...
0;this.dataPointMaxWidth&&e>u&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,u));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&u<e)&&(u=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));s<e&&(s=e);s>u&&(s=u);if(0<z.length)for(var E=C._colorSet,u=0;u<z.length;u++){var e=C.lineColor=C.options.color?C.options.color:E[0],T={color:z[u].whiskerColor?z[u].whiskerColor:z[u].color?C.whiskerColor?C.whiskerColor:z[u].color:C.whiskerColor?C.whiskerColor:e,thickness:r(z[u].whiskerThickness)?
C.whiskerThickness:z[u].whiskerThickness,dashType:z[u].whiskerDashType?z[u].whiskerDashType:C.whiskerDashType,length:r(z[u].whiskerLength)?r(C.options.whiskerLength)?s:C.options.whiskerLength:z[u].whiskerLength,trimLength:r(z[u].whiskerLength)?r(C.options.whiskerLength)?50:0:0};T.length="number"===typeof T.length?0>=T.length?0:T.length>=s?s:T.length:"string"===typeof T.length?parseInt(T.length)*s/100>s?s:parseInt(T.length)*s/100>s:s;T.thickness="number"===typeof T.thickness?0>T.thickness?0:Math.round(T.thickness):
2;var O={color:z[u].stemColor?z[u].stemColor:z[u].color?C.stemColor?C.stemColor:z[u].color:C.stemColor?C.stemColor:e,thickness:z[u].stemThickness?z[u].stemThickness:C.stemThickness,dashType:z[u].stemDashType?z[u].stemDashType:C.stemDashType};O.thickness="number"===typeof O.thickness?0>O.thickness?0:Math.round(O.thickness):2;z[u].getTime?v=z[u].x.getTime():v=z[u].x;if(!(v<a.axisX.dataInfo.viewPortMin||v>a.axisX.dataInfo.viewPortMax)&&!r(z[u].y)&&z[u].y.length&&"number"===typeof z[u].y[0]&&"number"===
typeof z[u].y[1]){var ja=a.axisX.convertValueToPixel(v);b?h=ja:k=ja;ja=a.axisY.convertValueToPixel(z[u].y[0]);b?p=ja:q=ja;ja=a.axisY.convertValueToPixel(z[u].y[1]);b?n=ja:g=ja;b?(q=a.axisX.reversed?h+(B?w:1)*s/2-(B?D-1:0)*s<<0:h-(B?w:1)*s/2+(B?D-1:0)*s<<0,g=a.axisX.reversed?q-s<<0:q+s<<0):(p=a.axisX.reversed?k+(B?w:1)*s/2-(B?D-1:0)*s<<0:k-(B?w:1)*s/2+(B?D-1:0)*s<<0,n=a.axisX.reversed?p-s<<0:p+s<<0);!b&&q>g&&(ja=q,q=g,g=ja);b&&p>n&&(ja=p,p=n,n=ja);ja=C.dataPointIds[u];this._eventManager.objectMap[ja]=
{id:ja,objectType:"dataPoint",dataSeriesIndex:F,dataPointIndex:u,x1:Math.min(p,n),y1:Math.min(q,g),x2:Math.max(n,p),y2:Math.max(g,q),isXYSwapped:b,stemProperties:O,whiskerProperties:T};y(c,Math.min(p,n),Math.min(q,g),Math.max(n,p),Math.max(g,q),e,T,O,b);t&&y(this._eventManager.ghostCtx,p,q,n,g,e,T,O,b);if(z[u].indexLabel||C.indexLabel||z[u].indexLabelFormatter||C.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:z[u],dataSeries:C,indexKeyword:0,point:{x:b?z[u].y[1]>=z[u].y[0]?
...
this.plotArea.ctx,b=t?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();t&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();t&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var u=0;u<a.dataSeriesIndexes.length;u++){var k=[],h=a.dataSeriesIndexes[u],p=this.data[h],n=p.dataPoints,f=p.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:h};f=Q(f);e.fillStyle=f;var f=[],q=
!0,g=0,m,r,w,s,x=null;if(0<n.length){var F=p._colorSet[g%p._colorSet.length],C=p.lineColor=p.options.lineColor||F,z=C;b.fillStyle=F;b.strokeStyle=C;b.lineWidth=p.lineThickness;var B="solid";if(b.setLineDash){var y=N(p.nullDataLineDashType,p.lineThickness),B=p.lineDashType,D=N(B,p.lineThickness);b.setLineDash(D)}for(var T=!0;g<n.length;g++)if(s=n[g].x.getTime?n[g].x.getTime():n[g].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!p.connectNullData||!T)))if(null!==n[g].y&&n[g].y.length&&
"number"===typeof n[g].y[0]&&"number"===typeof n[g].y[1]){m=a.axisX.convertValueToPixel(s);r=a.axisY.convertValueToPixel(n[g].y[0]);w=a.axisY.convertValueToPixel(n[g].y[1]);q||T?(p.connectNullData&&!q?(b.setLineDash&&(p.options.nullDataLineDashType||B===p.lineDashType&&p.lineDashType!==p.nullDataLineDashType)&&(k[k.length-1].newLineDashArray=D,B=p.nullDataLineDashType,b.setLineDash(y)),b.lineTo(m,r),t&&e.lineTo(m,r),k.push({x:m,y1:r,y2:w})):(b.beginPath(),b.moveTo(m,r),x={x:m,y:r},k=[],k.push({x:m,
y1:r,y2:w}),t&&(e.beginPath(),e.moveTo(m,r))),T=q=!1):(b.lineTo(m,r),k.push({x:m,y1:r,y2:w}),t&&e.lineTo(m,r),0==g%250&&d());s=p.dataPointIds[g];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:g,x1:m,y1:r,y2:w};g<n.length-1&&(z!==(n[g].lineColor||C)||B!==(n[g].lineDashType||p.lineDashType))&&(d(),z=n[g].lineColor||C,k[k.length-1].newStrokeStyle=z,b.strokeStyle=z,b.setLineDash&&(n[g].lineDashType?(B=n[g].lineDashType,k[k.length-1].newLineDashArray=N(B,
p.lineThickness),b.setLineDash(k[k.length-1].newLineDashArray)):(B=p.lineDashType,k[k.length-1].newLineDashArray=D,b.setLineDash(D))));if(0!==n[g].markerSize&&(0<n[g].markerSize||0<p.markerSize)){var O=p.getMarkerProperties(g,m,w,b);f.push(O);var E=Q(s);t&&f.push({x:m,y:w,ctx:e,type:O.type,size:O.size,color:E,borderColor:E,borderThickness:O.borderThickness});O=p.getMarkerProperties(g,m,r,b);f.push(O);E=Q(s);t&&f.push({x:m,y:r,ctx:e,type:O.type,size:O.size,color:E,borderColor:E,borderThickness:O.borderThickness})}if(n[g].indexLabel||
...
s;b.lineWidth=h.lineThickness;var C="solid",z;if(b.setLineDash){var B=N(h.nullDataLineDashType,h.lineThickness),C=h.lineDashType;z=N(C,h.lineThickness)}for(g=!1;n<p.length;n++)if(q=p[n].x.getTime?p[n].x.getTime():p[n].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!g)))if(null!==p[n].y&&p[n].y.length&&"number"===typeof p[n].y[0]&&"number"===typeof p[n].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(p[n].y[0]);v=a.axisY.convertValueToPixel(p[n].y[1]);
...
(0<p[n].markerSize||0<h.markerSize)){var D=h.getMarkerProperties(n,q,g,b);f.push(D);var T=Q(y);t&&f.push({x:q,y:g,ctx:e,type:D.type,size:D.size,color:T,borderColor:T,borderThickness:D.borderThickness});D=h.getMarkerProperties(n,q,v,b);f.push(D);T=Q(y);t&&f.push({x:q,y:v,ctx:e,type:D.type,size:D.size,color:T,borderColor:T,borderThickness:D.borderThickness})}if(p[n].indexLabel||h.indexLabel||p[n].indexLabelFormatter||h.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:p[n],
...
{percent:null,total:null},u=null,k=m.getPercentAndTotal(h,f);if(h.indexLabelFormatter||f.indexLabelFormatter)u={chart:m.options,dataSeries:h,dataPoint:f,total:k.total,percent:k.percent};k=f.indexLabelFormatter?f.indexLabelFormatter(u):f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,h,e):h.indexLabelFormatter?h.indexLabelFormatter(u):h.indexLabel?m.replaceKeywordsWithValue(h.indexLabel,f,h,e):f.label?f.label:"";m._eventManager.objectMap[l]=n;n.center={x:F.x,y:F.y};n.y=f.y;n.radius=B;n.percentInnerRadius=
D;n.indexLabelText=k;n.indexLabelPlacement=h.indexLabelPlacement;n.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:h.options.indexLabelLineColor?h.options.indexLabelLineColor:f.color?f.color:h._colorSet[e%h._colorSet.length];n.indexLabelLineThickness=r(f.indexLabelLineThickness)?h.indexLabelLineThickness:f.indexLabelLineThickness;n.indexLabelLineDashType=f.indexLabelLineDashType?f.indexLabelLineDashType:h.indexLabelLineDashType;n.indexLabelFontColor=f.indexLabelFontColor?f.indexLabelFontColor:
...
h.options.indexLabelBackgroundColor:h.indexLabelBackgroundColor;n.indexLabelMaxWidth=f.indexLabelMaxWidth?f.indexLabelMaxWidth:h.indexLabelMaxWidth?h.indexLabelMaxWidth:0.33*q.width;n.indexLabelWrap="undefined"!==typeof f.indexLabelWrap?f.indexLabelWrap:h.indexLabelWrap;n.startAngle=0===e?h.startAngle?h.startAngle/180*Math.PI:0:g[e-1].endAngle;n.startAngle=(n.startAngle+2*Math.PI)%(2*Math.PI);n.endAngle=n.startAngle+2*Math.PI/C*Math.abs(f.y);f=(n.endAngle+n.startAngle)/2;f=(f+2*Math.PI)%(2*Math.PI);
...
0<p[z].label.toString().length)&&(a=!0);if(0!==C){a=a||"undefined"!==typeof h.indexLabel&&null!==h.indexLabel&&0<h.indexLabel.toString().length;var B="inside"!==h.indexLabelPlacement&&a?0.75*Math.min(q.width,q.height)/2:0.92*Math.min(q.width,q.height)/2;h.radius&&(B=Ra(h.radius,B));var y="undefined"!==typeof h.innerRadius&&null!==h.innerRadius?Ra(h.innerRadius,B):0.7*B;h.radius=B;"doughnut"===h.type&&(h.innerRadius=y);var D=Math.min(y/B,(B-1)/B);this.pieDoughnutClickHandler=function(a){m.isAnimating||
!r(a.dataSeries.explodeOnClick)&&!a.dataSeries.explodeOnClick||(a=a.dataPoint,a.exploded=a.exploded?!1:!0,1<this.dataPoints.length&&m._animator.animate(0,500,function(a){c(a);k()}))};d();l();l();l();l();this.disableToolTip=!0;this._animator.animate(0,this.animatedRender?this.animationDuration:0,function(a){var b=m.plotArea.ctx;b.clearRect(q.x1,q.y1,q.width,q.height);b.fillStyle=m.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);a=g[0].startAngle+2*Math.PI*a;for(b=0;b<p.length;b++){var c=0===
b?g[b].startAngle:d,d=c+(g[b].endAngle-g[b].startAngle),e=!1;d>a&&(d=a,e=!0);var f=p[b].color?p[b].color:h._colorSet[b%h._colorSet.length];d>c&&ga(m.plotArea.ctx,g[b].center,g[b].radius,f,h.type,c,d,h.fillOpacity,g[b].percentInnerRadius);if(e)break}k()},function(){m.disableToolTip=!1;m._animator.animate(0,m.animatedRender?500:0,function(a){c(a);k()})})}}};var pa=function(a,d,c,b){"undefined"===typeof c&&(c=1);0>=Math.round(d.y4-d.y1)||(a.save(),a.globalAlpha=c,a.beginPath(),a.moveTo(Math.round(d.x1),
...
0;a+=Math.abs(x[c].y)}if(0===a)return-1;for(c=b[0]=0;c<x.length;c++)b.push(Math.abs(x[c].y)*D/a);return b}function c(){var a=Y,b=X,c=L,d=ba,e,f;e=K;f=P-S;d=Math.abs((f-e)*(b-a+(d-c))/2);c=ba-L;e=f-e;f=c*(f-P);f=Math.abs(f);f=d+f;for(var d=[],g=0,h=0;h<x.length;h++){if("undefined"===typeof x[h].y)return-1;x[h].y="number"===typeof x[h].y?x[h].y:0;g+=Math.abs(x[h].y)}if(0===g)return-1;for(var l=d[0]=0,k=0,n,p,b=b-a,l=!1,h=0;h<x.length;h++)a=Math.abs(x[h].y)*f/g,l?n=0==Number(c.toFixed(3))?0:a/c:(p=Z*
Z*b*b-4*Math.abs(Z)*a,0>p?(p=c,l=(b+p)*(e-k)/2,a-=l,n=e-k,k+=e-k,n+=0==p?0:a/p,k+=a/p,l=!0):(n=(Math.abs(Z)*b-Math.sqrt(p))/2,p=b-2*n/Math.abs(Z),k+=n,k>e&&(k-=n,p=c,l=(b+p)*(e-k)/2,a-=l,n=e-k,k+=e-k,n+=a/p,k+=a/p,l=!0),b=p)),d.push(n);return d}function b(){if(s&&x){for(var a,b,c,d,e,f,h,l,k,n,p,q,m,u,v=[],A=[],w={percent:null,total:null},B=null,z=0;z<x.length;z++)u=R[z],u="undefined"!==typeof u.x5?(u.y2+u.y4)/2:(u.y2+u.y3)/2,u=g(u).x2+1,v[z]=J-u-U;u=0.5*U;for(var z=0,F=x.length-1;z<x.length||0<=
F;z++,F--){b=s.reversed?x[F]:x[z];a=b.color?b.color:s.reversed?s._colorSet[(x.length-1-z)%s._colorSet.length]:s._colorSet[z%s._colorSet.length];c=b.indexLabelPlacement||s.indexLabelPlacement||"outside";d=b.indexLabelBackgroundColor||s.indexLabelBackgroundColor||(t?"transparent":null);e=b.indexLabelFontColor||s.indexLabelFontColor||"#979797";f=r(b.indexLabelFontSize)?s.indexLabelFontSize:b.indexLabelFontSize;h=b.indexLabelFontStyle||s.indexLabelFontStyle||"normal";l=b.indexLabelFontFamily||s.indexLabelFontFamily||
"arial";k=b.indexLabelFontWeight||s.indexLabelFontWeight||"normal";a=b.indexLabelLineColor||s.options.indexLabelLineColor||a;n="number"===typeof b.indexLabelLineThickness?b.indexLabelLineThickness:"number"===typeof s.indexLabelLineThickness?s.indexLabelLineThickness:2;p=b.indexLabelLineDashType||s.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof s.indexLabelWrap?s.indexLabelWrap:!0;m=s.dataPointIds[z];y._eventManager.objectMap[m]={id:m,
objectType:"dataPoint",dataPointIndex:z,dataSeriesIndex:0,funnelSection:R[s.reversed?x.length-1-z:z]};"inside"===s.indexLabelPlacement&&(v[z]=z!==aa?s.reversed?R[z].x2-R[z].x1:R[z].x3-R[z].x4:R[z].x3-R[z].x6,20>v[z]&&(v[z]=z!==aa?s.reversed?R[z].x3-R[z].x4:R[z].x2-R[z].x1:R[z].x2-R[z].x1,v[z]/=2));m=b.indexLabelMaxWidth?b.indexLabelMaxWidth:s.options.indexLabelMaxWidth?s.indexLabelMaxWidth:v[z];if(m>v[z]||0>m)m=v[z];A[z]="inside"===s.indexLabelPlacement?R[z].height:!1;w=y.getPercentAndTotal(s,b);
if(s.indexLabelFormatter||b.indexLabelFormatter)B={chart:y.options,dataSeries:s,dataPoint:b,total:w.total,percent:w.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(B):b.indexLabel?y.replaceKeywordsWithValue(b.indexLabel,b,s,z):s.indexLabelFormatter?s.indexLabelFormatter(B):s.indexLabel?y.replaceKeywordsWithValue(s.indexLabel,b,s,z):b.label?b.label:"";0>=n&&(n=0);1E3>m&&1E3-m<u&&(m+=1E3-m);Q.roundRect||Aa(Q);c=new ia(Q,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:h,fontWeight:k,horizontalAlign:c,
backgroundColor:d,maxWidth:m,maxHeight:!1===A[z]?q?4.28571429*f:1.5*f:A[z],text:b,padding:ca});c.measureText();H.push({textBlock:c,id:s.reversed?F:z,isDirty:!1,lineColor:a,lineThickness:n,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,h=J-X-U/2,h=s.options.indexLabelMaxWidth?s.indexLabelMaxWidth>h?h:s.indexLabelMaxWidth:h,l=H.length-1;0<=l;l--){g=x[H[l].id];c=H[l];d=c.textBlock;b=(a=
...
legend:this.options,dataSeries:n,dataPoint:null}):n.name,v=n.legendMarkerColor=n.legendMarkerColor?n.legendMarkerColor:n.markerColor?n.markerColor:"error"===n.type?r(n.whiskerColor)?n._colorSet[0]:n.whiskerColor:n._colorSet[0],t=n.markerSize||"line"!==n.type&&"stepLine"!==n.type&&"spline"!==n.type?0.75*this.lineHeight:0,w=n.legendMarkerBorderColor?n.legendMarkerBorderColor:n.markerBorderColor,s=n.legendMarkerBorderThickness?n.legendMarkerBorderThickness:n.markerBorderThickness?Math.max(1,Math.round(0.2*
t)):0;"error"===n.type&&this.errorMarkerColor.push(v);g=this.chart.replaceKeywordsWithValue(g,n.dataPoints[0],n,p);q={markerType:q,markerColor:v,text:g,textBlock:null,chartType:n.type,markerSize:t,lineColor:n._colorSet[0],dataSeriesIndex:n.index,dataPointIndex:null,markerBorderColor:w,markerBorderThickness:s};m.push(q)}else for(var x=0;x<n.dataPoints.length;x++){var y=n.dataPoints[x],q=y.legendMarkerType?y.legendMarkerType:n.legendMarkerType?n.legendMarkerType:K.getDefaultLegendMarker(n.type),g=y.legendText?
y.legendText:n.legendText?n.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:n,dataPoint:y}):y.name?y.name:"DataPoint: "+(x+1),v=y.legendMarkerColor?y.legendMarkerColor:n.legendMarkerColor?n.legendMarkerColor:y.color?y.color:n.color?n.color:n._colorSet[x%n._colorSet.length],t=0.75*this.lineHeight,w=y.legendMarkerBorderColor?y.legendMarkerBorderColor:n.legendMarkerBorderColor?n.legendMarkerBorderColor:y.markerBorderColor?y.markerBorderColor:
n.markerBorderColor,s=y.legendMarkerBorderThickness?y.legendMarkerBorderThickness:n.legendMarkerBorderThickness?n.legendMarkerBorderThickness:y.markerBorderThickness||n.markerBorderThickness?Math.max(1,Math.round(0.2*t)):0,g=this.chart.replaceKeywordsWithValue(g,y,n,x),q={markerType:q,markerColor:v,text:g,textBlock:null,chartType:n.type,markerSize:t,dataSeriesIndex:p,dataPointIndex:x,markerBorderColor:w,markerBorderThickness:s};(y.showInLegend||n.showInLegend&&!1!==y.showInLegend)&&m.push(q)}}!0===
this.reversed&&m.reverse();if(0<m.length){n=null;v=g=y=x=0;y=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=f;t=0===t?0.75*this.lineHeight:t;y-=t+k;for(p=0;p<m.length;p++){q=m[p];w=y;if("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType)w-=2*0.1*this.lineHeight;if(!(0>=l||"undefined"===typeof l||0>=w||"undefined"===typeof w)){if("horizontal"===
this.orientation){q.textBlock=new ia(this.ctx,{x:0,y:0,maxWidth:w,maxHeight:this.itemWrap?l:this.lineHeight,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"});q.textBlock.measureText();null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(t+k+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0)));if(!n||n.width+
Math.round(q.textBlock.width+t+k+(0===n.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))>f)n={items:[],width:0},h.push(n),this.height+=g,g=0;g=Math.max(g,q.textBlock.height)}else q.textBlock=new ia(this.ctx,{x:0,y:0,maxWidth:y,maxHeight:!0===this.itemWrap?l:1.5*this.fontSize,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,
fontStyle:this.fontStyle,textBaseline:"middle"}),q.textBlock.measureText(),null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(t+k+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))),this.height<l-this.lineHeight?(n={items:[],width:0},h.push(n)):(n=h[x],x=(x+1)%h.length),this.height+=q.textBlock.height;q.textBlock.x=n.width;q.textBlock.y=0;n.width+=Math.round(q.textBlock.width+t+k+(0===n.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===
q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0));n.items.push(q);this.width=Math.max(n.width,this.width);v=q.textBlock.width+(t+k+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))}}this.itemWidth=v;this.height=!1===this.itemWrap?h.length*this.lineHeight:this.height+g;this.height=Math.min(l,this.height);this.width=Math.min(f,this.width)}"top"===this.verticalAlign?(e="left"===this.horizontalAlign?d.x1:"right"===this.horizontalAlign?d.x2-
...
this.ctx.roundRect(a,d,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);for(var k=0,m=0;m<l.length;m++){for(var h=l[m],p=0,n=0;n<h.items.length;n++){var q=h.items[n],g=q.textBlock.x+a+(0===n?0.2*f:this.horizontalSpacing),r=d+k,t=g;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=0.5);this.ctx.save();this.ctx.beginPath();this.ctx.rect(a,d,b,Math.max(e-e%this.lineHeight,0));this.ctx.clip();if("line"===q.chartType||"stepLine"===q.chartType||
"spline"===q.chartType)this.ctx.strokeStyle=q.lineColor,this.ctx.lineWidth=Math.ceil(this.lineHeight/8),this.ctx.beginPath(),this.ctx.moveTo(g-0.1*this.lineHeight,r+this.lineHeight/2),this.ctx.lineTo(g+0.85*this.lineHeight,r+this.lineHeight/2),this.ctx.stroke(),t-=0.1*this.lineHeight;if("error"===q.chartType){this.ctx.strokeStyle=this.errorMarkerColor[0];this.ctx.lineWidth=f/8;this.ctx.beginPath();var w=g-0.08*this.lineHeight+0.1*this.lineHeight,s=r+0.15*this.lineHeight,x=0.7*this.lineHeight,y=x+
...
q.textBlock.x=g+c+f;if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)q.textBlock.x+=0.1*this.lineHeight;q.textBlock.y=Math.round(r+this.lineHeight/2);q.textBlock.render(!0);this.ctx.restore();p=0<n?Math.max(p,q.textBlock.height):q.textBlock.height;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=1);g=Q(q.id);this.ghostCtx.fillStyle=g;this.ghostCtx.beginPath();this.ghostCtx.fillRect(t,q.textBlock.y-this.lineHeight/2,q.textBlock.x+q.textBlock.width-t,q.textBlock.height);
q.x1=this.chart._eventManager.objectMap[q.id].x1=t;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/2}k+=p}};ma(K,I);K.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===
...
a||"stackedArea"===a||"stackedArea100"===a||"funnel"===a||"pyramid"===a)return"triangle";if("error"===a)return"none";window.console.log("Unknown Chart Type: "+a);return null};K.prototype.getDataPointAtX=function(a,d){if(!this.dataPoints||0===this.dataPoints.length)return null;var c={dataPoint:null,distance:Infinity,index:NaN},b=null,e=0,f=0,l=1,k=Infinity,m=0,h=0,p=0;"none"!==this.chart.plotInfo.axisPlacement&&(this.axisX.logarithmic?(p=Math.log(this.dataPoints[this.dataPoints.length-1].x/this.dataPoints[0].x),
...
a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),k=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var t=ha("markerSize",g,this)||4,w=c?20:t,r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=w&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=m?m=q:0<l?h++:p++;r<=t/2&&(k=!0);break;case "rangeArea":case "rangeSplineArea":t=ha("markerSize",g,this)||
4;w=c?20:t;r=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));r<=w&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=m?m=q:0<l?h++:p++;r<=t/2&&(k=!0);break;case "bubble":t=q.size;r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=t/2&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r}),k=!0);break;case "pie":case "doughnut":t=q.center;w="doughnut"===this.type?q.percentInnerRadius*q.radius:
0;r=Math.sqrt(Math.pow(t.x-a,2)+Math.pow(t.y-d,2));r<q.radius&&r>w&&(r=Math.atan2(d-t.y,a-t.x),0>r&&(r+=2*Math.PI),r=Number(((180*(r/Math.PI)%360+360)%360).toFixed(12)),t=Number(((180*(q.startAngle/Math.PI)%360+360)%360).toFixed(12)),w=Number(((180*(q.endAngle/Math.PI)%360+360)%360).toFixed(12)),0===w&&1<q.endAngle&&(w=360),t>=w&&0!==g.y&&(w+=360,r<t&&(r+=360)),r>t&&r<w&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:0}),k=!0));break;case "funnel":case "pyramid":r=q.funnelSection;
...
0:1.5*this.labelFontSize;for(b=0;b<this._labels.length;b++){a=this._labels[b].textBlock;a.maxWidth=f;a.maxHeight=l;var v=a.measureText();m=v.height}e=[];q=n=0;if(this.labelAutoFit||this.options.labelAutoFit)if(r(this.labelAngle)||(this.labelAngle=(this.labelAngle%360+360)%360,90<this.labelAngle&&270>this.labelAngle?this.labelAngle-=180:270<=this.labelAngle&&360>=this.labelAngle&&(this.labelAngle-=360)),"bottom"===this._position||"top"===this._position)if(f=0.9*k>>0,q=0,!this.chart.panEnabled&&1<=
...
l,this.sessionVariables.labelMaxWidth=f,d&&v.width+d.width>>0>2*f&&(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=p)):(this.sessionVariables.labelAngle=this.sessionVariables.labelMaxWidth>f?-25:this.sessionVariables.labelAngle,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelWrap=this.labelWrap);else{if(r(this.options.labelWrap))if(!r(this.options.labelMaxWidth))this.options.labelMaxWidth<f?
...
(h.y=this.chart.bounds.y1)}else if("left"===this.parent._position||"right"===this.parent._position){f=l=m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-n/2,x2:e,y2:l+n/2};C=!1;if(this.parent.labels)for(p=Math.ceil(this.parent.interval),v=0;v<this.parent.viewportMaximum;v+=p)if(this.parent.labels[v])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(v=
this.parent.convertPixelToValue({y:d}),t=null,w=0;w<this.parent.dataSeries.length;w++)(t=this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=t.index&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):r(this.options.label)?t.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:
x.dataPoint.x}):r(this.options.label)?ya(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.x}):r(this.options.label)?Z(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);h.y=l+h.fontSize/2-h.measureText().height/2+2;h.y-h.fontSize/2<this.chart.bounds.y1?h.y=this.chart.bounds.y1+
h.fontSize/2+2:h.y+h.measureText().height-h.fontSize/2>this.chart.bounds.y2&&(h.y=this.chart.bounds.y2-h.measureText().height+h.fontSize/2);"left"===this.parent._position?h.x=this.parent.lineCoordinates.x2-h.measureText().width:"right"===this.parent._position&&(h.x=this.parent.lineCoordinates.x2)}}else if("bottom"===this.parent._position||"top"===this.parent._position){v=this.parent.convertPixelToValue({x:a});for(w=0;w<this.parent.dataSeries.length;w++)(t=this.parent.dataSeries[w].getDataPointAtX(v,
!0))&&0<=t.index&&(t.dataSeries=this.parent.dataSeries[w],null!==t.dataPoint.y&&t.dataSeries.visible&&p.push(t));if(0===p.length)return;p.sort(function(a,b){return a.distance-b.distance});x=p[0];b=e=k=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;f=this.chart.plotArea.y1;l=this.chart.plotArea.y2;this.bounds={x1:b-n/2,y1:f,x2:e+n/2,y2:l};C=!1;if(this.parent.labels)for(p=Math.ceil(this.parent.interval),v=0;v<this.parent.viewportMaximum;v+=
p)if(this.parent.labels[v])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({x:a}),t=null,w=0;w<this.parent.dataSeries.length;w++)(t=this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=t.index&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):r(this.options.label)?t.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):r(this.options.label)?ya(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):r(this.options.label)?Z(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=x.dataPoint.x;h.x=b-h.measureText().width/2;h.x+
h.width>this.chart.bounds.x2&&(h.x=this.chart.bounds.x2-h.width);h.x<this.chart.bounds.x1&&(h.x=this.chart.bounds.x1);"bottom"===this.parent._position?h.y=this.parent.lineCoordinates.y2+h.fontSize/2+2:"top"===this.parent._position&&(h.y=this.parent.lineCoordinates.y1-h.height+h.fontSize/2+2)}else if("left"===this.parent._position||"right"===this.parent._position){!r(this.parent.dataSeries)&&0<this.parent.dataSeries.length&&(v=this.parent.dataSeries[0].axisX.convertPixelToValue({x:a}));for(w=0;w<this.parent.dataSeries.length;w++)(t=
this.parent.dataSeries[w].getDataPointAtX(v,!0))&&0<=t.index&&(t.dataSeries=this.parent.dataSeries[w],null!==t.dataPoint.y&&t.dataSeries.visible&&p.push(t));if(0===p.length)return;p.sort(function(a,b){return a.distance-b.distance});w=0;if("rangeColumn"===p[0].dataSeries.type||"rangeArea"===p[0].dataSeries.type||"error"===p[0].dataSeries.type||"rangeSplineArea"===p[0].dataSeries.type||"candlestick"===p[0].dataSeries.type||"ohlc"===p[0].dataSeries.type||"boxAndWhisker"===p[0].dataSeries.type)for(t=
Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y[0])),v=s=0;v<p.length;v++)if(p[v].dataPoint.y&&p[v].dataPoint.y.length)for(x=0;x<p[v].dataPoint.y.length;x++)s=Math.abs(d-this.parent.convertValueToPixel(p[v].dataPoint.y[x])),s<t&&(t=s,w=v);else s=Math.abs(d-this.parent.convertValueToPixel(p[v].dataPoint.y)),s<t&&(t=s,w=v);else if("stackedColumn"===p[0].dataSeries.type||"stackedArea"===p[0].dataSeries.type)for(t=Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y)),v=y=s=0;v<p.length;v++)if(p[v].dataPoint.y&&
p[v].dataPoint.y.length)for(x=0;x<p[v].dataPoint.y.length;x++)s=Math.abs(d-this.parent.convertValueToPixel(p[v].dataPoint.y[x])),s<t&&(t=s,w=v);else y+=p[v].dataPoint.y,s=Math.abs(d-this.parent.convertValueToPixel(y)),s<t&&(t=s,w=v);else if("stackedColumn100"===p[0].dataSeries.type||"stackedArea100"===p[0].dataSeries.type)for(t=Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y)),v=C=y=s=0;v<p.length;v++)if(p[v].dataPoint.y&&p[v].dataPoint.y.length)for(x=0;x<p[v].dataPoint.y.length;x++)s=
Math.abs(d-this.parent.convertValueToPixel(p[v].dataPoint.y[x])),s<t&&(t=s,w=v);else y+=p[v].dataPoint.y,C=p[v].dataPoint.x.getTime?p[v].dataPoint.x.getTime():p[v].dataPoint.x,C=100*(y/p[v].dataSeries.plotUnit.dataPointYSums[C]),s=Math.abs(d-this.parent.convertValueToPixel(C)),s<t&&(t=s,w=v);else for(t=Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y)),v=s=0;v<p.length;v++)if(p[v].dataPoint.y&&p[v].dataPoint.y.length)for(x=0;x<p[v].dataPoint.y.length;x++)s=Math.abs(d-this.parent.convertValueToPixel(p[v].dataPoint.y[x])),
s<t&&(t=s,w=v);else s=Math.abs(d-this.parent.convertValueToPixel(p[v].dataPoint.y)),s<t&&(t=s,w=v);x=p[w];b=0;if("rangeColumn"===this.parent.dataSeries[w].type||"rangeArea"===this.parent.dataSeries[w].type||"error"===this.parent.dataSeries[w].type||"rangeSplineArea"===this.parent.dataSeries[w].type||"candlestick"===this.parent.dataSeries[w].type||"ohlc"===this.parent.dataSeries[w].type||"boxAndWhisker"===this.parent.dataSeries[w].type){t=Math.abs(d-this.parent.convertValueToPixel(x.dataPoint.y[0]));
for(v=s=0;v<x.dataPoint.y.length;v++)s=Math.abs(d-this.parent.convertValueToPixel(x.dataPoint.y[v])),s<t&&(t=s,b=v);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y[b])<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y[b]}):r(this.options.label)?Z(c?c:x.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):this.label;this.value=
x.dataPoint.y[b]}else if("stackedColumn"===this.parent.dataSeries[w].type||"stackedArea"===this.parent.dataSeries[w].type){t=Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y));y=s=0;for(v=w;0<=v;v--)y+=p[v].dataPoint.y,s=Math.abs(d-this.parent.convertValueToPixel(y)),s<t&&(t=s,b=v);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y)<<0)+0.5:this.parent.convertValueToPixel(y)<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
value:c?c:x.dataPoint.y}):r(this.options.label)?Z(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=y}else if("stackedColumn100"===this.parent.dataSeries[w].type||"stackedArea100"===this.parent.dataSeries[w].type){t=Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y));y=s=0;for(v=w;0<=v;v--)y+=p[v].dataPoint.y,C=p[v].dataPoint.x.getTime?p[v].dataPoint.x.getTime():p[v].dataPoint.x,C=100*(y/p[v].dataSeries.plotUnit.dataPointYSums[C]),s=Math.abs(d-this.parent.convertValueToPixel(C)),
s<t&&(t=s,b=v);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:C}):r(this.options.label)?Z(c?c:C,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=C}else"waterfall"===this.parent.dataSeries[w].type?(m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<0)+
0.5:this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<0,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataSeries.dataPointEOs[x.index].cumulativeSum}):r(this.options.label)?Z(c?c:x.dataSeries.dataPointEOs[x.index].cumulativeSum,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=x.dataSeries.dataPointEOs[x.index].cumulativeSum):(m=1===q.lineWidth%2?(r(a)?d:this.parent.convertValueToPixel(x.dataPoint.y)<<
...
for(b=0;b<k.length;b++)k[b].dataPoint.x.valueOf()===c.dataPoint.x.valueOf()&&f.push(k[b]);k=null}else{if(h=this.chart.getDataPointAtXY(a,d,c))this.currentDataPointIndex=h.dataPointIndex,this.currentSeriesIndex=h.dataSeries.index;else if(t)if(h=Ya(a,d,this.chart._eventManager.ghostCtx),0<h&&"undefined"!==typeof this.chart._eventManager.objectMap[h]){h=this.chart._eventManager.objectMap[h];if("legendItem"===h.objectType)return;this.currentSeriesIndex=h.dataSeriesIndex;this.currentDataPointIndex=0<=
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();y.version="v3.2.8 GA";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
